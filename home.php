                ...
                <div class="row">
                    ...
                    ?>
                        ...
                        <div class="card m-3 ml-5" style="width: 18rem;" style="width: 18rem;">
                            <img class="card-img-top" src="uploads/testimg.png" alt="Card image cap" width="200px" height="250px">
                            <div class="card-body">
                                <h4 class="card-title"> <?php echo $webname ?> </h4>
                                <h6 class="card-title"> <?php echo $web_url ?> </h6>
                                <a href="slots.php?web_id=<?php echo $web_id ?>" class="btn btn-success" style="margin-right:3px;"> Go to Slots </a>
                            </div>
                        </div>
